...
*  **Git rebase** : Git rebase moves or replay commits from one branch on top of other branch creating a clean linear history.
...
![Git Workflow Diagram](simple-jar-project-/nm1w0gnf2zh11.png)
